...
#CHIBIOS_VERSION=16.1.8
#CHIBIOS_VERSION=16.1.x
...
BMC_SRC = usbcfg.c dfu.c fxp.c x.c tps56.c clk156.c smbus.c pmbus_cmd.c smb_cmd.c ucd9090_config.c main.c
PAC_SRC       = pac1720.c
SHELL_CMD_SRC = shell_cmds.c
#ADC_SRC       = adc.c
TIM_SRC       = tim1_tim8.c
PWR_SRC       = power_ctl.c
