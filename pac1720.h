...
#define PAC1720_REG_POWER_RATIO_CH1_HL     0x16
#define PAC1720_REG_POWER_RATIO_CH2_HB     0x17
#define PAC1720_REG_POWER_RATIO_CH2_HL     0x18
...
float readCurrentValue(I2CDriver* i2cp, i2caddr_t addr, channel_t ch, uint8_t rSens);
float readVoltagValue(I2CDriver* i2cp, i2caddr_t addr, channel_t ch);
